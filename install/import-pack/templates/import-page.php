...
<div id="Import_Pack_Container">
    ...
    <h1 class="heading-page"><?php echo apply_filters( 'influencers/import_pack/heading_text', __( 'Influencers Import Package Demo.', 'influencers' ) ); ?></h1>

    <?php do_action( 'influencers/import_pack/before' ); ?>
            ...
            <ul class="ip-tab-heading">
                ...
                <li class="__open-ticket">
                    <a href="<?php echo esc_url( IMPORT_URL_OPEN_TICKET ); ?>" target="_blank">
                        ...
                        <?php _e( 'Open Ticket', 'influencers' ); ?>
                    </a>
                </li>
            </ul> <!-- .ip-tab-heading -->
    ...
    <div class="ip-footer">
        <?php echo apply_filters( 'influencers/import_pack/footer_text', __( 'Power by Beplus, Thank you creating with Influencers.', 'influencers' ) ); ?>
    </div>

    <?php do_action( 'influencers/import_pack/after' ); ?>
...
<div id="Import_Pack_Modal" class="ip-modal-container">
    <div class="ip-modal">
        <div class="ip-modal-header">
            <a href="javascript:" class="__close" title="<?php echo esc_attr( 'close', 'influencers' ); ?>">
