<?php
namespace InfluencersElementorWidgets\Widgets\SiteSocial;
...
class Widget_SiteSocial extends Widget_Base {
	...
	public function get_title() {
		return __( 'Site Social', 'influencers' );
	}
	...
	protected function register_content_section_controls() {
		...
		$this->add_control(
			'title',
			[
				'label' => esc_html__( 'Title', 'influencers' ),
	...
	protected function register_style_content_section_controls() {
		...
		$this->add_control(
			'title_color',
			[
				'label' => __( 'Title Color', 'influencers' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Title Typography', 'influencers' ),
				'default' => '',
